# Frontends Projects - Animated Search Bar 

![Animated Search Bar ](/Design/animatedSearchbar.png)

---
Project: Animated Search Bar \
Stack: HTML & CSS\
Level: Beginner\
Demo : [Demo](https://animated-searchbar.netlify.app/)\
Tutorial : [Tutorialurl](https://frontendsprojects.teachable.com/courses/frontend-projects-tutorial/lectures/39100558)

---

### Project Brief
#### In this tutorial we’re going to learn how to create a animated search bar using only html and css
